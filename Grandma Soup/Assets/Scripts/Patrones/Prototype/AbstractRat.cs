...
{
    public abstract class AbstractRat : IPrototypeRat
    {
        Camera cam;
        ...
        public AbstractRat(string type)
        {
        ...
        public abstract IPrototypeRat Clone();
        ...
        public bool ProcessCollissions(IPrototypeRat otherSoldier)
        {
